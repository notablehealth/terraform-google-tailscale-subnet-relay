...
| <a name="input_enable_display"></a> [enable\_display](#input\_enable\_display) | Enable display for debugging | `bool` | `false` | no |
...
| <a name="input_tailscale_tags"></a> [tailscale\_tags](#input\_tailscale\_tags) | List of Tailscale tags | `set(string)` | `[]` | no |
...
| <a name="output_network_ip"></a> [network\_ip](#output\_network\_ip) | The private IPv4 address assigned to the instance |
